...
$html = loadTemplate("signalLiveModeButtonSignal_design.html");
...
if ($check==1)
{
  ...
  if ($obj=mysqli_fetch_OBJECT($erg))
  {
    ...
    die($obj->id."#<a href='editButtonPage.php?action=$action&pageId=$pageId&buttonId=$buttonId&featureInstanceId=$senderId&featureFunctionId=$fktData->id&param1Value=$param1Value&param2Value=$param2Value' target='main'><img src='img/action.gif' border=0> ".$obj->function." ".$obj->sender."</a><br>");
  }
  else die("");
}
