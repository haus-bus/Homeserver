...
class FeatureFunctionBitmask extends BaseModel
{
    ...
    /**
     * @var int $bit the bit number of the byte (0-7)
     */
    private $bit;
    ...
    /**
     * @return int the bit number of the byte (0-7)
     */
    ...
    /**
     * @param int $bit the bit number of the byte (0-7)
     */
